...
export const actions = {
    getProvincesData({ commit }) {
        return new Promise((resolve, reject) => {
            this.$axios.get('/api/v1/web/rajaongkir/provinces')
            .then((response) => {
    ...
    getCitiesData({ commit }, payload) {
        return new Promise((resolve, reject) => {
            this.$axios.post('/api/v1/web/rajaongkir/cities', payload)
            .then((response) => {
    ...
    getOngkirData({ commit }, payload) {
        return new Promise((resolve, reject) => {
            this.$axios.post('/api/v1/web/rajaongkir/checkOngkir', payload)
            .then((response) => {
