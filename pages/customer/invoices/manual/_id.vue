              ...
              <div class="card-body">
                <div class="row">
                    ...
                    <!-- <div class="col text-right">
                        <button @click="showIns" v-if="invoice.status == 'pending'" class="btn btn-primary"> <i class="fa fa-info"></i> PAYMENT INSTRUCTION</button>
                    </div> -->
                </div>
                <hr>
                          ...
                          <tr>
                            ...
                            <td>
                              <button v-if="invoice.status == 'pending'"
                                class="btn btn-info">PENDING (WAITING FOR PAYMENT)</button>
  ...
  <script>
    ...
    export default {
      ...
      async asyncData({ store, route }) {
        await store.dispatch('customer/invoice/getDetailManualInvoice', route.params.id)
      },
      computed: {
        invoice() {
      ...
      methods: {
        showIns(){
            if (this.instructionsDisplayed == false){
