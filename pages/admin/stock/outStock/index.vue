            ...
            <div class="col-md-12">
              <div class="card border-0 rounded shadow-sm">
                <div class="card-header">
                  <span class="font-weight-bold"><i class="fa fa-layer-group"></i> PRODUCT OUT OF STOCKS</span>
                </div>
                <div class="card-body">
  ...
  <script>
    export default {
      ...
      async asyncData({ store }) {
        await store.dispatch('admin/stock/getOutStockData')
      },
      ...
      methods: {
        ...
        changePage(page) {
            ...
            this.$store.dispatch('admin/stock/getOutStockData', this.search)
        },
      }
