<template>
            ...
            <div class="col-md-12">
              <div class="card border-0 rounded shadow-sm border-top-orange">
                <div class="card-header">
                  <span class="font-weight-bold"><i class="fa fa-folder"></i> ADD PAYMENT BANK ACCOUNT</span>
                </div>
                <div class="card-body">
                  <form @submit.prevent="storeBankAcc">
                    <div class="row py-3">
                      <div class="col">
  ...
  <script>
    export default {
      ...
      head() {
        return {
          title: 'Add New Payment Bank Account - Administrator',
        }
      },
      data() {
        return {
