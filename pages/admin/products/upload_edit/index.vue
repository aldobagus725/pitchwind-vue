          ...
          <div class="col-md-12">
            <div class="card border-0 rounded shadow-sm border-top-orange">
              <div class="card-header">
                <span class="font-weight-bold"><i class="fa fa-folder"></i> UPDATE PRODUCT</span>
              </div>
              <div class="card-body">
...
<script>
  export default {
    ...
    head() {
      return {
        title: 'Update Product - Administrator',
      }
    },
    data() {
      return {
    ...
    methods: {
      ...
      async uploadProduct() {
        ...
        await this.$store.dispatch('admin/product/uploadProductUpdate', formData)
          .then(() => {
            this.$swal.fire({
              title: 'SUCCESS!',
