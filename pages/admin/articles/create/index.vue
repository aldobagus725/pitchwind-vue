<template>
            ...
            <div class="col-md-12">
              <div class="card border-0 rounded shadow-sm border-top-orange">
                <div class="card-header">
                  <span class="font-weight-bold"><i class="fa fa-folder"></i> ADD ARTICLE</span>
                </div>
                <div class="card-body">
  ...
  <script>
    export default {
      ...
      head() {
        return {
          title: 'Add New Article - Administrator',
        }
      },
      ...
      methods: {
        ...
        handleFileChange(e) {
          ...
          if (!image.type.match('image.*')) {
            ...
            //set state "article.image" to null
        ...
        async storeArticle() {
          ...
          formData.append('body', this.article.category_id)
          formData.append('published', this.article.published)
          //sending data to action "storeArticle" vuex
          await this.$store.dispatch('admin/article/storeArticle', formData)
            //success
            .then(() => {
              //sweet alert
              this.$swal.fire({
