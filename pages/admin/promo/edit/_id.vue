            ...
            <div class="col-md-12">
              <div class="card border-0 rounded shadow-sm border-top-orange">
                <div class="card-header">
                  <span class="font-weight-bold"><i class="fa fa-folder"></i> EDIT PROMO</span>
                </div>
                <div class="card-body">
  ...
  <script>
    export default {
      ...
      async asyncData({ store, route }) {
          await store.dispatch('admin/promo/getOnePromo', route.params.id)
      },
      //mounted
      mounted() {
          this.promo.title = this.$store.state.admin.promo.promo.title
          this.promo.from_date = this.$store.state.admin.promo.promo.from_date
          this.promo.to_date = this.$store.state.admin.promo.promo.to_date
          this.promo.description = this.$store.state.admin.promo.promo.description
      },
      methods: {
        async updatePromo() {
          ...
          await this.$store.dispatch('admin/promo/updatePromo', {
