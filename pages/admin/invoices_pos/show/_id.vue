            ...
            <div class="col-md-12">
              <div class="card border-0 rounded shadow-sm border-top-orange">
                <div class="card-header">
                  <span class="font-weight-bold"><i class="fa fa-shopping-cart"></i> DETAIL INVOICE POS</span>
                </div>
                <div class="card-body">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tr>
                      ...
                      <td>:</td>
                      <td>
                        Rp. {{ formatPrice(invoice.courier_cost)  }}
                      </td>
                    </tr>
                    <tr>
                      <td>
              ...
              <div class="card border-0 rounded shadow-sm border-top-orange mt-4">
                ...
                <div class="card-body">
                  <table class="table"
                    ...
                    <tbody>
                      <tr v-for="order in invoice.orders_pos" :key="order.id" style="background: #edf2f7;">
